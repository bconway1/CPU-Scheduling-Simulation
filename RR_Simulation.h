...
#ifndef SIMULATION_PROJECT_RR_SIMULATION_H
#define SIMULATION_PROJECT_RR_SIMULATION_H
...
public:
    ...
    std::string log_file_name = "D:/Classes/CS520/Simulation_Project/RR_log.txt";
    ...
    RR_Simulation(double time_quantum);
...
#endif //SIMULATION_PROJECT_RR_SIMULATION_H
